...
--
-- Host: localhost
-- Generation Time: Dec 22, 2025 at 01:37 AM
...
INSERT INTO `colaborador` (`id_colaborador`, `nombre`, `apellido`, `n_identificacion`, `id_tipo_id`, `correo`, `clave`, `telefono`, `direccion`, `id_estado_colaborador`, `foto`) VALUES
(1, 'Juan', 'Lopez', 123456, 1, 'juan.lopez@gymfit.com', 'abc123', '3111111111', 'Calle 1 #10-20', 1, NULL),
(2, 'Maria', 'Gomez', 789012, 1, 'maria.gomez@gymfit.com', 'abc123', '3222222222', 'Calle 2 #20-30', 2, NULL);
